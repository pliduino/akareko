...
//     },
// };
// use tokio::io::{AsyncRead, AsyncReadExt as _, AsyncWrite, AsyncWriteExt as
// _};

// use crate::errors::{DecodeError, EncodeError};

// pub async fn encode_serde<W, T>(v: &T, writer: &mut W) -> Result<(),
// EncodeError> where
...
// pub async fn decode_serde<'de, R, T>(reader: &mut R) -> Result<T,
// DecodeError> where
...
//     fn serialize_field<T>(&mut self, _: &'static str, value: &T) ->
