...
//                     fn from_value(value: surrealdb_types::Value) ->
// Result<Self, surrealdb::Error>                     where
//                         Self: Sized,
//                     {
//                         match value.kind() {
//                             surrealdb::types::Kind::String => {
//                                 [<String
// $bits>]::new(value.into_string()?).map_err(|_| {
...
//                             });
//                         }
//                         writer.[<write_u $bits>](self.0.len() as [<u
// $bits>]).await?;
// writer.write(self.0.as_bytes()).await?;                         Ok(())
//                     }
